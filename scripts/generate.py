...
{{
  ...
  "key_points": [
    ...
    "記事の重要ポイント2（50文字以内）",
    "記事の重要ポイント3（50文字以内）",
    "記事の重要ポイント4（50文字以内、なければ省略可）"
  ],
  "body_paragraphs": [
    "記事の内容を著者の口調・温度感を保って要約した文章（1段落目・100文字程度）",
    "記事の内容を著者の口調・温度感を保って要約した文章（2段落目・100文字程度）",
    "記事の内容を著者の口調・温度感を保って要約した文章（3段落目・100文字程度、なければ省略可）"
  ],
  "quote": "記事の中で最も印象的な一文・名言（60文字以内）"
}}
